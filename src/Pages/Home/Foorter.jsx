  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/benas.vildzius"
            ...
            <li>
              <a
                href="https://www.instagram.com/benas_vildzius"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="http://www.linkedin.com/in/benas-vildžius-23438a258"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Benas</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
